            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10 pb-10 border-b border-gray-800">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm text-gray-300">
                        ...
                        <li class="flex items-start gap-2">
                            ...
                            <a href="https://maps.app.goo.gl/55b4wrDFGa32Yxuo8" target="_blank" rel="noopener noreferrer" class="hover:text-green-300">Zaylora spices,<br>Mammattikanam P.O, road, Pazhayaviduthi, Rajakkad, Kuthumkal, Kerala 685566</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="md:text-right">
                    ...
                    <div class="flex gap-4 md:justify-end">
                        <a href="https://www.instagram.com/zayloraspices?igsh=OXNmbGFvbm84bDY2" class="text-gray-400 hover:text-white transition-colors" aria-label="Instagram">
                        ...
                        <a href="https://www.facebook.com/profile.php?id=61579515101333&mibextid=wwXIfr" class="text-gray-400 hover:text-white transition-colors" aria-label="Facebook">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                            </svg>
                        </a>
                        <a href="https://wa.me/919074862344" target="_blank" class="text-gray-400 hover:text-white transition-colors" aria-label="WhatsApp">
