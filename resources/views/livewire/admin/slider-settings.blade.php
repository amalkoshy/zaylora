<div class="max-w-2xl space-y-6">
    ...
    @php
        $slots = [
            1 => ['label' => 'Slide 1', 'existing' => $existingSliderImage1, 'field' => 'sliderImage1', 'preview' => $sliderImage1],
            2 => ['label' => 'Slide 2', 'existing' => $existingSliderImage2, 'field' => 'sliderImage2', 'preview' => $sliderImage2],
            3 => ['label' => 'Slide 3', 'existing' => $existingSliderImage3, 'field' => 'sliderImage3', 'preview' => $sliderImage3],
        ];
    @endphp
    ...
    <div>
        ...
        >
            <span wire:loading.remove wire:target="save">Save Slider Images</span>
